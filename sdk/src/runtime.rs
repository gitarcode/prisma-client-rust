...
impl GeneratorMetadata {
    ...
    fn generate(&self, engine_dmmf: EngineDMMF) -> Result<(), GeneratorError> {
        ...
        let query_schema = Arc::new(schema_builder::build(internal_data_model, true));
        ...
        generated_str += &(self.generate_fn)(
            GenerateArgs::new(datamodel, dmmf.schema, engine_dmmf),
            config,
        )?;
